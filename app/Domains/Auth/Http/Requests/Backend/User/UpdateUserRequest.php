...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            }), Rule::in([User::TYPE_ADMIN, User::TYPE_USER, User::TYPE_MEMBER, User::TYPE_FIGHTER, User::TYPE_TRAINER])],
            'name' => ['required', 'max:100'],
            'email' => ['required', 'max:255', 'email', Rule::unique('users')->ignore($this->user->id)],
            'profileimage' => ['sometimes', '', 'image', 'mimes:jpeg,png,jpg,gif'],
            'payouts' => ['sometimes', ''],
            'age' => ['sometimes', '', 'numeric', 'max:100'],
            'weight' => ['sometimes', '', 'numeric', 'max:100'],
            'location' => ['sometimes', ''],
            'fightingstyle' => ['sometimes', ''],
            'bio' => ['sometimes', ''],
            'goals' => ['sometimes', ''],
