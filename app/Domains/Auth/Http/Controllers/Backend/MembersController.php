...
class MembersController
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route('admin.members.index')->withFlashSuccess(__('The Members was successfully created.'));
    }
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.members.show', $user)->withFlashSuccess(__('The Members was successfully updated.'));
    }
    ...
    public function destroy(DeleteUserRequest $request, User $user)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('The Members was successfully deleted.'));
    }
}
