...
class FighterController
{
    ...
    {
        return view('backend.fighter.index');
    }

    public function show(User $user)
    {
        return view('backend.fighter.show')
            ->withUser($user);
    }
    ...
    {
        return view('backend.fighter.edit')
            ->withUser($user)
    ...
    public function update(UpdateUserRequest $request, User $user)
    {
        ...
        return redirect()->route('admin.fighter.index', $user)->withFlashSuccess(__('The Fighter was successfully updated.'));
    }
    ...
    public function destroy(DeleteUserRequest $request, User $user)
    {
        ...
        return redirect()->back()->withFlashSuccess(__('The Fighter was successfully deleted.'));
    }
}
