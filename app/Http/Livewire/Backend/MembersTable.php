...
use App\Exports\members as members;
...
class MembersTable extends DataTableComponent
{
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Name'))
                ->sortable(),
            Column::make(__('Subscription'), 'subscription')
                ->sortable(),
    ...
    {
        return 'backend.members.includes.row';
    }
    ...
    public function exportSelected()
    {
        ...
        if ($this->selectedRowsQuery->count() > 0) {
            ...
            return Excel::download(new members($this->selectedRowsQuery), 'report.xlsx');
        }
