...
use App\Exports\fighter as fighter;

/**
 * Class UsersTable.
 */
class FighterTable extends DataTableComponent
{
    /**
     * @var
     */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make(__('Name'))
                ->sortable(),
            Column::make(__('Fights'))
                ->sortable(),
            Column::make(__('Winnings'), 'winnings')
                ->sortable(),
    ...
    {
        return 'backend.fighter.includes.row';
    }
    ...
    public function exportSelected()
    {
        ...
        if ($this->selectedRowsQuery->count() > 0) {
            ...
            return Excel::download(new fighter($this->selectedRowsQuery), 'report.xlsx');
        }
